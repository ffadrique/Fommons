...
! Initialise test suite
  suite = xfunit_suite( package=package, &
                        source='m_iso8601_time.f03', &
                        annotation='Unit testing of ISO8601 time format' )

! Create test
  ut = xfunit_unit( name='unit_m_iso8601_time_test_001', &
                    classname="t_iso8601_time", &
                    executer=unit_m_iso8601_time_test_001, &
                    annotation='Constructor/destructor' )
  call suite%add_unit_test( ut )

! Create test
  ut = xfunit_unit( name='unit_m_iso8601_time_test_002', &
                    classname="t_iso8601_time", &
                    executer=unit_m_iso8601_time_test_002, &
                    annotation='Get/set functions' )
  call suite%add_unit_test( ut )

! Create test
  ut = xfunit_unit( name='unit_m_iso8601_time_test_003', &
                    classname="t_iso8601_time", &
                    executer=unit_m_iso8601_time_test_003, &
                    annotation='Time formatting' )
  call suite%add_unit_test( ut )
...
end program unit_m_iso8601_time
